...
@Service
public class PaymentFakeCreditCardServiceImpl implements PaymentService {

    @Override
    public PaymentResponse executePayment(PaymentRequest paymentRequest) {
        return PaymentResponse.builder()
                .message("Payment via CreditCard successfully executed.")
                .paymentType(PaymentType.CREDIT_CARD.getPaymentType()).build();
    }
